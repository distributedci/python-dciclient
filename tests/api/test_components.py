...
def test_get_or_create_component(dci_context, topic_id):
    ...
    assert existing_component["display_name"] is "display_component1"
    assert existing_component["version"] is "1.2.3"
    ...
    assert existing_component["display_name"] is "display_component2"
    assert existing_component["version"] is "2.3.4"
