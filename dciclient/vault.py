...
Edit the command line arguments to replace --vault-id <name> with --vault-id <name>@dci-vault-client.
If no --vault-id argument is passed, add --vault-id dci-vault-client argument at the end.
Then call ansible-vault with the modified arguments.
'''
